# 🕌 Allah Everywhere - Islamic Companion App<p align="center"><div align="center"># ALLAH EVERYWHERE - Islamic Mobile Application# Allah Every Where - Islamic Flutter App# ALLAH EVERYWHERE - Islamic Mobile Application# allah_every_where



> A comprehensive, feature-rich Flutter application providing Muslims with essential religious tools and resources for spiritual guidance and daily Islamic practice.  <img src="https://raw.githubusercontent.com/AbduLlAh72727272/ALLAH_EVERYWHERE/main/assets/icons/app_icon.png" alt="Allah Everywhere" width="120" height="120">



[![Flutter](https://img.shields.io/badge/Flutter-3.5.1-blue.svg)](https://flutter.dev)</p>
...
## ✨ Features<h1 align="center">🕌 Allah Everywhere</h1># 🕌 ALLAH EVERYWHERE 🌙
...
- **Holy Quran**: Complete Quran with Arabic text and multiple translations<p align="center">### *Your Complete Islamic Companion*

- **Authentic Hadith**: Major collections (Bukhari, Muslim, Abu Dawood, etc.)

- **Qibla Direction**: Compass-integrated Mecca direction finder  <strong>Your Ultimate Islamic Companion App</strong>

- **Islamic Calendar**: Hijri dates with important Islamic events

- **Scholar Consultation**: Live chat with qualified Islamic scholars</p><div align="center">



### 🎨 **User Experience**

- **Beautiful UI**: Islamic-themed design with elegant Arabic typography

- **Audio Recitation**: Listen to Quran recitations by renowned Qaris<p align="center">![Islamic Banner](https://img.shields.io/badge/🕋-ISLAMIC%20APP-green?style=for-the-badge&labelColor=darkgreen)

- **Prayer Tracking**: Mark completed prayers and build spiritual habits

- **Bookmarking System**: Save favorite verses and Hadith for quick access  <img src="https://img.shields.io/github/v/release/AbduLlAh72727272/ALLAH_EVERYWHERE?style=flat-square&color=green" alt="Version">

- **Offline Support**: Access Islamic content without internet connection

- **Multi-language**: Support for Arabic, English, Urdu, and more  <img src="https://img.shields.io/github/stars/AbduLlAh72727272/ALLAH_EVERYWHERE?style=flat-square&color=yellow" alt="Stars">![Version](https://img.shields.io/badge/VERSION-2.0-gold?style=for-the-badge)  



### 🔥 **Premium Features**  <img src="https://img.shields.io/github/forks/AbduLlAh72727272/ALLAH_EVERYWHERE?style=flat-square&color=blue" alt="Forks">

- **Smart Notifications**: Customizable prayer time alerts with Adhan

- **Advanced Search**: Find Quranic verses and Hadith by keywords or topics  <img src="https://img.shields.io/github/license/AbduLlAh72727272/ALLAH_EVERYWHERE?style=flat-square&color=orange" alt="License">![Status](https://img.shields.io/badge/STATUS-ACTIVE-brightgreen?style=for-the-badge)

- **Reading Progress**: Track your Quran reading journey with statistics

- **Islamic Knowledge**: Duas, 99 Names of Allah, and Fiqh guidance</p>

- **Community Features**: Connect with fellow Muslims worldwide

- **Verse Highlighting**: Audio synchronization with Quranic text  [![Flutter](https://img.shields.io/badge/Flutter-02569B?style=for-the-badge&logo=flutter&logoColor=white)](https://flutter.dev/)<div align="center">



## 🏗️ Architecture<p align="center">
...
│   └── auth_controller.dart  [![Dart](https://img.shields.io/badge/Dart-0175C2?style=for-the-badge&logo=dart&logoColor=white)](https://dart.dev/)  <h3>A comprehensive Islamic companion app built with Flutter</h3>
...
│   ├── surah.dart**Allah Everywhere** is a comprehensive Islamic mobile application built with Flutter that brings the essence of Islam to your fingertips. Whether you're looking for accurate prayer times, reading the Holy Quran, exploring authentic Hadiths, or seeking guidance from Islamic scholars, this app serves as your complete spiritual companion.

│   ├── hadith.dart

│   ├── qibla.dart*Built with ❤️ for the Global Muslim Ummah*  

│   ├── auth/

│   │   ├── login.dart> *"And whoever relies upon Allah - then He is sufficient for him. Indeed, Allah will accomplish His purpose."* - **Quran 65:3**
...
│       └── editprofilescreen.dart![Downloads](https://img.shields.io/badge/DOWNLOADS-10K+-success?style=flat-square)  <h3>A comprehensive Islamic companion app built with Flutter</h3>  <div align="center">A new Flutter project.

├── services/                    # Business logic & API services

│   ├── QuranService.dart## ✨ Key Features

│   ├── HadithService.dart

│   ├── PrayerService.dart![Rating](https://img.shields.io/badge/RATING-⭐⭐⭐⭐⭐-yellow?style=flat-square)

│   ├── AuthService.dart

│   └── ChatService.dart### 🕐 Prayer Times & Qibla
...
└── widgets/                     # Reusable components
    ...
    ├── hadith_card.dart- **Qibla direction** with compass integration  
...
## 🚀 Getting Started- **Monthly prayer calendar** view
...
- **Complete Quran** with beautiful Arabic typography

### Installation

- **Multiple translations** in 20+ languages---
...
1. **Clone the repository**
   ...
   cd ALLAH_EVERYWHERE- **Verse-by-verse highlighting** during audio playback

   ```

- **Bookmarks and notes** for personal study

2. **Install dependencies**

   ```bash- **Advanced search** by keywords or topics## 🌟 **Why Choose Allah Everywhere?**## 📖 About  [![Firebase](https://img.shields.io/badge/Firebase-039BE5?style=for-the-badge&logo=Firebase&logoColor=white)](https://firebase.google.com/)  <h3>A comprehensive Islamic companion app built with Flutter</h3>
...
3. **Set up Firebase**### 📜 Authentic Hadiths

   - Create a Firebase project at [Firebase Console](https://console.firebase.google.com/)

   - Add your `google-services.json` to `android/app/`- **Major collections**: Bukhari, Muslim, Abu Dawood, Tirmidhi, Nasai, Ibn Majah

   - Add your `GoogleService-Info.plist` to `ios/Runner/`

   - Update `lib/firebase_options.dart` with your configuration- **Original Arabic text** with accurate translations<table>



4. **Configure APIs**- **Topic-based categorization** for easy browsing
...
5. **Run the app**- **Personal favorites** and sharing capabilities

   ```bash

   flutter run<td width="33%" align="center">Allah Everywhere is a comprehensive Islamic mobile application designed to provide Muslims with essential religious tools and resources. The app offers a seamless experience for prayer times, Quran reading, Islamic knowledge, and spiritual guidance.  [![Dart](https://img.shields.io/badge/Dart-0175C2?style=for-the-badge&logo=dart&logoColor=white)](https://dart.dev/)
...
flutter build appbundle --release- **Prophetic medicine** (Tibb-e-Nabwi) guidance
...
<details>- **Community Support**: Connect with fellow Muslims

## 🔄 Recent Updates

<summary><b>📜 AUTHENTIC HADITH</b> - Click to expand</summary>

### v2.0.0 - Major Release

- ✅ **Enhanced Quran Service**: Switched to AlQuran.cloud API for better Arabic text support- **Expert Guidance**: Receive authentic Islamic advice

- ✅ **Improved Hadith API**: Multiple fallback mechanisms for 99.9% uptime

- ✅ **Bug Fixes**: Resolved compilation errors and dependency conflicts> **Prophetic wisdom at your fingertips**

- ✅ **Performance**: 50% faster loading times with optimized caching

- ✅ **UI/UX**: Modern Islamic design with improved accessibility



---- 📚 **Major Collections** - Sahih Bukhari, Muslim, Abu Dawood, Tirmidhi



## 🗺️ Roadmap- 🔍 **Smart Search** - Find Hadith by topic, narrator, or keywords### 🛠️ Additional Features### 📚 Quran Features



### v2.1 (Next Release)- 📖 **Arabic & Translation** - Original Arabic with accurate translations

- [ ] Web platform support

- [ ] Offline Quran storage- ⭐ **Favorites System** - Save important Hadith for quick access- **Tasbeeh Counter**: Digital prayer beads with customizable dhikr

- [ ] Advanced search filters

- [ ] Widget support for home screen- 📊 **Classification** - Sahih, Hasan, Daif grading system



### v3.0 (Future)- 🏷️ **Topic Categories** - Organized by Islamic topics- **Islamic Calendar**: Hijri dates and Islamic events- **Complete Quran**: Full Arabic text with multiple translations

- [ ] AI-powered Islamic Q&A

- [ ] Augmented Reality Qibla- 📤 **Easy Sharing** - Share Hadith with beautiful formatting

- [ ] Community features

- [ ] Islamic education courses- **Mosque Finder**: Locate nearby mosques with prayer times
...
We welcome contributions from the Muslim developer community! Here's how you can help:<details>



1. **Fork the repository**<summary><b>👨‍🎓 SCHOLAR CONSULTATION</b> - Click to expand</summary>- **User Profiles**: Personalized experience with progress tracking
...
5. **Open a Pull Request**> **Get authentic Islamic guidance**- **Offline Support**: Access content without internet connection- **Bookmarking System**: Save your favorite verses for quick access
...
- Ensure Islamic content authenticity- 💬 **Live Chat** - Real-time communication with qualified scholars- **Multi-language Support**: Available in multiple languages

- Write clear commit messages

- Add tests for new features- ❓ **Q&A Platform** - Ask questions and get detailed answers

- Update documentation

- 🎓 **Expert Profiles** - Learn about scholars' qualifications- **Search Functionality**: Find verses by keyword or topic[online documentation](https://docs.flutter.dev/), which offers tutorials,

---

- 🌍 **Global Network** - Scholars from around the world

## 📄 License

- 📚 **Knowledge Base** - Extensive FAQ database## 🚀 Getting Started

This project is licensed under the MIT License - see the [LICENSE](LICENSE) file for details.

- 🔔 **Response Alerts** - Get notified when scholars respond

### Islamic Content Notice

All Islamic content in this application is handled with utmost respect and is sourced from authentic Islamic references. Users are encouraged to verify religious content with qualified Islamic scholars.- 🏆 **Community Rating** - Rate and review scholar responses- **Reading Progress**: Track your Quran reading journey
...
## 🙏 Acknowledgments</details>### Prerequisites
...
- **Islamic Scholars** - For their knowledge and wisdom<details>- Flutter SDK (3.5.1 or later)- **Multiple Translations**: Support for various languages and interpretations## ✨ Featuressamples, guidance on mobile development, and a full API reference.

- **Flutter Community** - For the amazing framework

- **API Providers** - AlQuran.cloud, Hadith API, Aladhan API<summary><b>🛠️ ADDITIONAL TOOLS</b> - Click to expand</summary>
...
> **Complete Islamic lifestyle support**

## 📞 Support

- Android Studio / VS Code- **Verse-by-Verse Audio**: Play individual verses with highlighting

Need help or have questions? Reach out to us:

- 📿 **Digital Tasbeeh** - Customizable dhikr counter with vibration

- 📧 **Email**: support@allah-everywhere.app

- 💬 **Discord**: [Join our community](https://discord.gg/allah-everywhere)- 🕌 **Mosque Finder** - Locate nearby mosques with prayer times- Firebase account for backend services

- 🐛 **Issues**: [GitHub Issues](https://github.com/AbduLlAh72727272/ALLAH_EVERYWHERE/issues)

- 📖 **Docs**: [Documentation](https://docs.allah-everywhere.app)- 🗓️ **Islamic Events** - Ramadan, Hajj, and other important dates



---- 🎯 **Duas Collection** - 100+ authentic supplications for all occasions#   A L L A H _ E V E R Y W H E R E 



## 📚 Islamic Resources- 📱 **Beautiful UI** - Modern Islamic design with dark/light themes



### Recommended Reading- 🌐 **Multi-language** - Available in 10+ languages### Installation

- 📖 The Holy Quran

- 📜 Sahih Bukhari & Sahih Muslim- 👤 **User Profiles** - Personalized experience with progress tracking

- 📘 Riyadh-us-Saliheen

- 📗 Fortress of the Muslim- 🔄 **Auto Sync** - Cloud backup for bookmarks and preferences### 🎓 Islamic Knowledge



### Useful Links

- [IslamQA.info](https://islamqa.info) - Authentic Islamic Q&A

- [Sunnah.com](https://sunnah.com) - Hadith collections</details>1. **Clone the repository**
...
<summary><b>Click to see guidelines</b></summary>- /calendar/{month}/{year} - Get monthly prayer times   - Enable Google Sign-In   ```



#### **Code Standards**- /gToH/{date} - Convert Gregorian to Hijri date

- ✅ Follow Flutter/Dart best practices

- ✅ Write meaningful commit messages```   - Configure authorized domains
...
## Recent Updates ✅3. **Configure Firebase**

#### **What We Need**

- 🌍 **Translators** - Help translate to more languages

- 👨‍💻 **Developers** - Add new Islamic features

- 🎨 **Designers** - Improve UI/UX with Islamic aesthetics### Fixed Issues2. **Firestore Database**   - Create a new Firebase project

- 📚 **Islamic Scholars** - Verify religious content accuracy

- 🧪 **Testers** - Help us find and fix bugs- **Quran Arabic Text**: Improved Arabic text visibility using AlQuran.cloud API



#### **Recognition**- **Hadith API**: Enhanced reliability with multiple API endpoints and fallback mechanisms   - Create a Firestore database   - Add your Android/iOS app to the project

- 🏆 Top contributors get special badges

- 📜 Names in app credits- **Build Issues**: Resolved all compilation errors and dependency conflicts

- 🎁 Islamic books/gifts for major contributions

- 🤝 Join our developer community- **Service Architecture**: Updated to use static methods for better performance   - Set up security rules for user data   - Download and place the configuration files:



</details>- **Translation System**: Improved translation handling with better error recovery
